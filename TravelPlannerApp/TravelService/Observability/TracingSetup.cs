...
{
    /// <summary>
    /// Distributed Tracing setup za TravelService.
    ///
    ...
    /// pre nego sto Service Fabric uopste otvori bilo koji listener. Da je obrnuto,
    /// instrumentacija ne bi bila registrovana kada stigne prvi remoting poziv i ti
    /// span-ovi bi bili izgubljeni.
    ///
    /// TracerProvider je proces-globalan; jednom napravljen, hvata sve Activity objekte
    /// iz registrovanih izvora bez obzira na to u kom delu procesa nastaju.
    /// </summary>
    internal static class TracingSetup
    {
        /// <summary>Ime servisa kako se prikazuje u Jaeger UI-u i u resource atributima.</summary>
        public const string ServiceName = "TravelService";
        ...
        /// pozivi nemaju efekta (Service Fabric moze da instancira servis vise puta u
        /// istom procesu ako ima vise instanci na istom cvoru).
        /// </summary>
        public static void Initialize(ServiceContext context)
        {
            ...
            lock (SyncRoot)
            {
                ...
                _tracerProvider = Sdk.CreateTracerProviderBuilder()
                    ...
                    // Span-ovi za SQL upite koje EF Core generise ka TravelDb bazi.
                    // Zahvaljujuci ovome se u jednom trace-u vidi i koliko je vremena
                    // potroseno u bazi, a ne samo u servisu.
