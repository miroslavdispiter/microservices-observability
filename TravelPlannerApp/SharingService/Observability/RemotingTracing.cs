...
//
//  Rezultat: jedan trace-id prolazi kroz WebApiService -> Remoting -> ovaj servis, pa se
//  u Jaegeru vidi kompletan lanac poziva sa vremenima svakog koraka.
//
...
//  assembly-ju procesa (ovde SharingService.exe). Zato atribut stoji ovde, u servisu, i
...
//  SharingService je StatefulService, pa remoting listener nastaje kroz
//  CreateServiceRemotingReplicaListeners(), ali je mehanizam identican.
// =====================================================================================
